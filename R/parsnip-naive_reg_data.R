...
make_random_walk_reg <- function() {
    
    model <- "random_walk_reg"
    ...
    parsnip::set_model_arg(
        model        = model,
        eng          = "stan",
        parsnip      = "seasonal_random_walk",
        original     = "seasonal",
        func         = list(pkg = "seasonal", fun = "seasonal_random_walk"),
        has_submodel = FALSE
    )
    ...
    parsnip::set_model_arg(
        ...
        original     = "m",
        func         = list(pkg = "period", fun = "seasonal_period"),
        has_submodel = FALSE
    )
    ...
    parsnip::set_fit(
        ...
        value         = list(
            ...
            protect   = c("x", "y"),
            func      = c(fun = "random_walk_stan_fit_impl"),
            defaults  = list()
        )
    )
