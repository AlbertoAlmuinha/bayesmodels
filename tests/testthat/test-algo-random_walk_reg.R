# ---- STANDARD ARIMA ----
context("TEST random_walk_reg: stan")
...
# TESTS
test_that("sarima_reg: stan, (No xregs), Test Model Fit Object", {
    
    testthat::expect_s3_class(model_fit$fit, "random_walk_stan_fit_impl")
...
test_that("random_walk_reg: stan, (No xregs), Test Predictions", {
...
# TESTS
test_that("random_walk_reg: stan, (XREGS), Test Model Fit Object", {
...
test_that("random_walk_reg: stan (XREGS), Test Predictions", {
...
# TESTS
test_that("random_walk_reg: stan (workflow), Test Model Fit Object", {
    
    testthat::expect_s3_class(wflw_fit$fit$fit$fit, "random_walk_stan_fit_impl")
...
test_that("random_walk_reg: stan (workflow), Test Predictions", {
