# ---- STANDARD ARIMA ----
context("TEST additive_state_space: stan")
...
# TESTS
test_that("additive_state_space: stan, (No xregs), Test Model Fit Object", {
    
    testthat::expect_s3_class(model_fit$fit, "ssm_stan_fit_impl")
...
test_that("additive_state_space: stan, (No xregs), Test Predictions", {
...
# TESTS
test_that("additive_state_space: stan, (XREGS), Test Model Fit Object", {
...
test_that("additive_state_space: stan (XREGS), Test Predictions", {
...
# TESTS
test_that("additive_state_space: stan (workflow), Test Model Fit Object", {
    
    testthat::expect_s3_class(wflw_fit$fit$fit$fit, "ssm_stan_fit_impl")
...
test_that("additive_state_space: stan (workflow), Test Predictions", {
