...
test_that("sarima_reg: stan, (No xregs), Test Model Fit Object", {
    ...
    testthat::expect_s3_class(model_fit$fit, "Sarima_stan_fit_impl")
...
test_that("sarima_reg: stan, (No xregs), Test Predictions", {
...
# TESTS
test_that("sarima_reg: stan, (XREGS), Test Model Fit Object", {
...
# TESTS
test_that("sarima_reg: stan (workflow), Test Model Fit Object", {
    
    testthat::expect_s3_class(wflw_fit$fit$fit$fit, "Sarima_stan_fit_impl")
...
test_that("sarima_reg: stan (workflow), Test Predictions", {
